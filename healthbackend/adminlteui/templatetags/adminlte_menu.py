...
def get_menu(context, request, position: Literal['main', 'top'] = 'main'):
    ...
    #print('__________________available_app__________________________________________________________')
    #print(available_apps)
    if not available_apps:

        # Django 1.8 on app index only
        available_apps = context.get('app_list')
        #print('__________app_list__________________________________________________________________')
        #print(available_apps)
